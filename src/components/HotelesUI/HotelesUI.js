...
function HotelesUI() {
  ...
  function deleteHotel(id) {
    try {
      axios.delete(`http://localhost:3001/Route/elimHotel/${id}`);
      ...
      {hoteles !== null ? (
        <div className="grid place-content-center">
          {hoteles.map((hotel) => (
            <div
              key={hotel.id}
              className="inline-block border border-gray-200 rounded-xl mb-12"
            >
              <div className="flex item-center justify-between p-4 border-b border-solid">
                <div className="flex items-center justify-between mx-auto max-w-4xl">
                  ...
                  <div className="mr-90">
                    <p className="pl-2">
                      Año de inaguracion: {hotel.anio_inaguracion}
                    </p>
              ...
              <div className="flex item-center justify-center">
                <button
                  className="px-2 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md ml-5 mr-5"
